...
export default function SettingsPage() {
  const [siteName, setSiteName] = useState("Onyu");
  const [facebook, setFacebook] = useState("");
  const [instagram, setInstagram] = useState("");
  const [linkedin, setLinkedin] = useState("");
  const [footerText, setFooterText] = useState(
    "Korea's Burnout & Workplace Well-being Knowledge Library"
  );
  ...
  function handleSave() {
    ...
    alert("Settings saved! (Demo mode — connect Supabase to persist)");
  }
      ...
      <div className="mt-8 space-y-6">
        ...
        <div>
          ...
          <div className="mt-2 flex h-20 items-center justify-center rounded-md border-2 border-dashed border-line bg-paper text-[13px] text-ink-soft/60">
            Upload logo (Connect Supabase Storage)
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2 flex h-16 items-center justify-center rounded-md border-2 border-dashed border-line bg-paper text-[13px] text-ink-soft/60">
            Upload favicon
          </div>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="mt-2 rounded-md border border-line bg-paper px-4 py-2.5 text-[14px] text-ink outline-none focus:border-brass"
          >
